...
export function AboutMe() {
  return (
    <motion.div key="about-me-section" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
      ...
      <Paragraph>
        I was born 2002, Russia. At school I was fond of technical sciences. Later began to study html make-up and
        javascript. Now I am a 2nd-year student of software engineering speciality at DSTU.
      </Paragraph>
